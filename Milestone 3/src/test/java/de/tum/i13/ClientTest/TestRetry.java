...
public class TestRetry {
    ...
    private static void launchServer(boolean test) throws IOException, InterruptedException {
        ...
        String[] args = {"-s", "FIFO", "-c", "100", "-d", "data/", "-l", "loggg.log", "-ll", "OFF", "-b", "127.0.0.1:59857", "-p", String.valueOf(port)};
    ...
    public void putRetry(){
        ...
        kv.setServerStatus(new ServerStatus(Constants.LOCKED));
        ...
        kv.setServerStatus(new ServerStatus(Constants.ACTIVE));
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            e.printStackTrace();
