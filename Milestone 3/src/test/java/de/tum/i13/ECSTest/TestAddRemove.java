...
public class TestAddRemove {
    ...
    public void addServer() throws IOException {
        String[] req1 = new String[]{"newServer", "1.1.1.1", "1", "1"};
        String[] req2 = new String[]{"newServer", "222.222.222.222", "2222", "2"};
        ...
        tm.put(ex.computeHash("1.1.1.1", 1), null);
        tm.put(ex.computeHash("222.222.222.222", 2222), null);
    ...
    public void removeServer() throws IOException {
        ...
        ex.addNewServer(req1, "1.1.1.1", null, null);
        ex.addNewServer(req2, "222.222.222.222", null, null);
        String[] req3 = new String[]{"shutdownServer", "1", "1"};
        String[] req4 = new String[]{"shutdownServer", "2222", "2"};
