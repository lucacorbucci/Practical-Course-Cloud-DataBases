...
public interface FileMapInterface {
     ...
     */
    String remove(String key, Object... password) throws FileNotFoundException, InvalidPasswordException;
     ...
     */
    rebalanceReturn addPair(String key, Pair<String, String> value) throws InvalidPasswordException;
     ...
     * @return the value associated with key, null if the key is not present in the database
     */
    String getValue(String key, Object... p) throws FileNotFoundException;
}
