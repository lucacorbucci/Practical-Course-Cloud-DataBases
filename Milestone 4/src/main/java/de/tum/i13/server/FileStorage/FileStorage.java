...
public class FileStorage implements FileStorageInterface {
     ...
     */
    public ArrayList<Pair<String, String>> getRange(String end, String start) {
        if (map != null) {
    ...
    public Pair<ArrayList<Pair<String, String>>, ArrayList<Pair<String, String>>> getReplicas(Pair<String, String> predecessorHash, Pair<String, String> predPredHash) {
        ArrayList<Pair<String, String>> predecessor = new ArrayList<>();
        ArrayList<Pair<String, String>> predPred = new ArrayList<>();
        map.forEach((s, file) -> {
            HashMap<String, String> kvalue = null;
            try {
