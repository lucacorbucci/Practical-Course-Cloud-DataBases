...
public interface FileMapInterface {
     ...
     */
    String remove(String key) throws FileNotFoundException;
     ...
     */
    rebalanceReturn addPair(String key, String value);
     ...
     * @return the value associated with key, null if the key is not present in the database
     */
    String getValue(String key) throws FileNotFoundException;
}
