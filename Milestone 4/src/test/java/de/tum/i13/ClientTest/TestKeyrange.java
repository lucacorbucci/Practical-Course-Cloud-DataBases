...
public class TestKeyrange {
    ...
    private static void launchServer(boolean test) throws InterruptedException {
        ECS ex = new ECS(51333, "OFF");
        ecs = new Thread(ex);
        ecs.start();
        while(!ex.isReady()){
            Thread.sleep(1);
        ...
        String[] args1 = {"-s", "FIFO", "-c", "100", "-d", "data/", "-l", "logKR1.log", "-ll", "OFF", "-b", "127.0.0.1:51333", "-p", String.valueOf(port1)};
        ...
        String[] args2 = {"-s", "FIFO", "-c", "100", "-d", "data2/", "-l", "logKR12.log", "-ll", "OFF", "-b", "127.0.0.1:51333", "-p", String.valueOf(port2)};
        ...
        String[] args3 = {"-s", "FIFO", "-c", "100", "-d", "data2/", "-l", "logKR13.log", "-ll", "OFF", "-b", "127.0.0.1:51333", "-p", String.valueOf(port3)};
    ...
    @Test
    void keyrange() throws InterruptedException {
